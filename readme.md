...
## 🎯 Project Goal
To show the difference between a standard approach to building Docker images and an optimized one. By using multi-stage builds, the final image size was reduced by **almost 8 times (from ~1.6 GB to ~201 MB)**. This significantly speeds up deployment, saves disk space, and reduces the attack surface (Security best practices).
